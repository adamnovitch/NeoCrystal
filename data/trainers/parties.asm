...
FalknerGroup:
	...
	db 12, HOOTHOOT,   CONFUSION, MUD_SLAP, GUST, FORESIGHT
	db 14, NATU,       CONFUSION, MUD_SLAP, PECK, LEER
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 22, FURRET,     QUICK_ATTACK, ATTRACT, DEFENSE_CURL, FURY_SWIPES
	db 22, TEDDIURSA,  SCRATCH, LEER, LICK, ATTRACT
...
BugsyGroup:
	...
	db 15, YANMA,      FURY_CUTTER, GUST, DOUBLE_TEAM, QUICK_ATTACK
	db 15, SHUCKLE,    FURY_CUTTER, WITHDRAW, CONSTRICT, ROLLOUT
	db 19, LEDIAN,     AIR_CUTTER, FURY_CUTTER, CONFUSION, FAIRY_WIND
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 25, HAUNTER,    SHADOW_BALL, NIGHT_SHADE, MEAN_LOOK, THIEF
	db 28, PARASECT,   SPORE, LEECH_LIFE, NIGHT_SHADE, MEGA_DRAIN
	db 25, MISDREAVUS, SCREECH, CONFUSE_RAY, SHADOW_BALL, PSYBEAM
	db 30, GENGAR,     MEGA_DRAIN, SHADOW_BALL, MEAN_LOOK, PSYCHIC_M
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 32, CLOYSTER,   SPIKE_CANNON, ICY_WIND, BUBBLEBEAM, SUPERSONIC
	db 35, DELIBIRD,   ICY_WIND, AIR_CUTTER, SWIFT, RAPID_SPIN
	db 35, JYNX,       ICY_WIND, PSYCHIC_M, LOVELY_KISS, SWEET_KISS
	db 37, PILOSWINE,  ICY_WIND, BODY_SLAM, ROCK_SLIDE, ANCIENTPOWER
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 36, FORRETRESS, SWIFT, PROTECT, ROLLOUT, SPIKES
	db 36, SCIZOR,     METAL_CLAW, SLASH, AGILITY, LIGHT_SCREEN
	db 36, SKARMORY,   STEEL_WING, SWIFT, AGILITY, SAND_ATTACK
	db 42, STEELIX,    IRON_TAIL, SANDSTORM, RAGE, ROCK_SLIDE
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 32, MACHOKE,   DYNAMICPUNCH, KARATE_CHOP, FORESIGHT, HEADBUTT
	db 32, MANKEY,    LEER, RAGE, KARATE_CHOP, DYNAMICPUNCH
	db 36, PRIMEAPE,  ROCK_SLIDE, RAGE, KARATE_CHOP, DYNAMICPUNCH
...
ClairGroup:
	...
	db 44, SEADRA,     SMOKESCREEN, SURF, ICE_BEAM, DRAGONBREATH
	db 44, GROWLITHE,  FLAME_WHEEL, TAKE_DOWN, LEER, DRAGONBREATH
	db 44, CHARMELEON, FLAMETHROWER, SLASH, SMOKESCREEN, DRAGONBREATH
	db 48, DRAGONAIR,  THUNDERBOLT, SURF, FLAMETHROWER, DRAGONBREATH
	db -1 ; end
...
Rival1Group:
	...
	db 23, TAUROS,     HORN_ATTACK, RAGE, SCARY_FACE, HEADBUTT
	db 26, MAGNEMITE,  THUNDER_WAVE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 26, EEVEE,      QUICK_ATTACK, SAND_ATTACK, TAIL_WHIP, SWIFT
	db 29, BAYLEEF,    HEADBUTT, SYNTHESIS, RAZOR_LEAF, POISONPOWDER
	db -1 ; end
	...
	db 26, MAGNEMITE,  THUNDER_WAVE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 26, EEVEE,      QUICK_ATTACK, SAND_ATTACK, TAIL_WHIP, SWIFT
	db 29, QUILAVA,    LEER, SMOKESCREEN, EMBER, HEADBUTT
	db -1 ; end
	...
	db 26, MAGNEMITE,  THUNDER_WAVE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 26, EEVEE,      QUICK_ATTACK, SAND_ATTACK, TAIL_WHIP, SWIFT
	db 29, CROCONAW,   LEER, RAGE, WATER_GUN, BITE
	db -1 ; end

	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 39, SHUCKLE,    SAFEGUARD, ENCORE, WRAP, WITHDRAW
	db 36, JOLTEON,    THUNDER, THUNDER_WAVE, DOUBLE_KICK, PIN_MISSILE
	db 39, TAUROS,     HORN_ATTACK, RAGE, PURSUIT, TAIL_WHIP
	db 42, GLIGAR,     SLASH, FAINT_ATTACK, SAND_ATTACK, METAL_CLAW
	db 42, MEGANIUM,   BODY_SLAM, SOLARBEAM, SYNTHESIS, SUNNY_DAY
	db -1 ; end
	...
	db 39, TAUROS,     HORN_ATTACK, RAGE, PURSUIT, TAIL_WHIP
	db 42, GLIGAR,     SLASH, FAINT_ATTACK, SAND_ATTACK, METAL_CLAW
	db 42, TYPHLOSION, FLAMETHROWER, SWIFT, SMOKESCREEN, REVERSAL
	db -1 ; end
	...
	db 39, TAUROS,     HORN_ATTACK, RAGE, PURSUIT, TAIL_WHIP
	db 42, GLIGAR,     SLASH, FAINT_ATTACK, SAND_ATTACK, METAL_CLAW
	db 42, FERALIGATR, SLASH, SURF, SCREECH, BITE
	db -1 ; end

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 44, DODRIO,     TRI_ATTACK, DRILL_PECK, MUD_SLAP, STEEL_WING
	db 47, SHUCKLE,    SAFEGUARD, TOXIC, SWAGGER, WITHDRAW
	db 46, JOLTEON,    THUNDER, THUNDER_WAVE, SHADOW_BALL, REFLECT
	db 46, TAUROS,     EARTHQUAKE, BODY_SLAM, RAGE, THUNDERBOLT
	db 46, GLIGAR,     SLASH, SLUDGE_BOMB, WING_ATTACK, EARTHQUAKE
	db 50, URSARING,   CRUNCH, EARTHQUAKE, HYPER_BEAM, THUNDERPUNCH
	db -1 ; end
	...
	db 47, SHUCKLE,    SAFEGUARD, TOXIC, SWAGGER, WITHDRAW
	db 46, JOLTEON,    THUNDER, THUNDER_WAVE, SHADOW_BALL, REFLECT
	db 46, TAUROS,     EARTHQUAKE, BODY_SLAM, RAGE, FLAMETHROWER
	db 46, GLIGAR,     SLASH, SLUDGE_BOMB, WING_ATTACK, EARTHQUAKE
	db 50, URSARING,   CRUNCH, EARTHQUAKE, HYPER_BEAM, FIRE_PUNCH
	db -1 ; end
	...
	db 47, SHUCKLE,    SAFEGUARD, TOXIC, SWAGGER, WITHDRAW
	db 46, JOLTEON,    THUNDER, THUNDER_WAVE, SHADOW_BALL, REFLECT
	db 46, TAUROS,     EARTHQUAKE, BODY_SLAM, RAGE, ICE_BEAM
	db 46, GLIGAR,     SLASH, SLUDGE_BOMB, WING_ATTACK, EARTHQUAKE
	db 50, URSARING,   CRUNCH, EARTHQUAKE, HYPER_BEAM, ICE_PUNCH
	db -1 ; end
...
WillGroup:
	...
	db 55, XATU,       DRILL_PECK, FAINT_ATTACK, CONFUSE_RAY, PSYCHIC_M
	db 55, WOBBUFFET,  COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db 56, SLOWKING,   REFLECT, SWAGGER, SURF, PSYCHIC_M
	db 55, GIRAFARIG,  HEADBUTT, THUNDERBOLT, CRUNCH, PSYCHIC_M
	db 57, ESPEON,     MORNING_SUN, SWIFT, CHARM, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 56, HITMONTOP,  TRIPLE_KICK, QUICK_ATTACK, DIG, DETECT
	db 56, HITMONLEE,  SWAGGER, BODY_SLAM, HI_JUMP_KICK, FORESIGHT
	db 56, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 58, HERACROSS,  MEGAHORN, REVERSAL, FLAIL, EARTHQUAKE
	db 60, MACHAMP,    ROCK_SLIDE, FORESIGHT, VITAL_THROW, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 58, SNEASEL,    SWORDS_DANCE, SLASH, ICE_PUNCH, FAINT_ATTACK
	db 61, UMBREON,    SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, MOONLIGHT
	db 60, HOUNDOOM,   CRUNCH, FLAMETHROWER, FAINT_ATTACK, REVERSAL
	db 58, MURKROW,    DRILL_PECK, FAINT_ATTACK, MUD_SLAP, STEEL_WING
	db 63, TYRANITAR,  EARTHQUAKE, CRUNCH, ROCK_SLIDE, STOMP
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 56, ARIADOS,    DOUBLE_TEAM, SPIDER_WEB, TOXIC, SLUDGE_BOMB
	db 58, WEEZING,    SMOKESCREEN, SLUDGE_BOMB, PAIN_SPLIT, TOXIC
	db 59, NIDOKING,   SLUDGE_BOMB, EARTHQUAKE, THIEF, ICE_BEAM
	db 56, MUK,        SLUDGE_BOMB, ACID_ARMOR, GIGA_DRAIN, SUBSTITUTE
	db 61, CROBAT,     CONFUSE_RAY, FAINT_ATTACK, WING_ATTACK, TOXIC
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_ITEM_MOVES
	db 60, AERODACTYL, GOLD_BERRY,   SPIKES, DRAGONBREATH, EARTHQUAKE, HYPER_BEAM
	db 60, ARBOK,      GOLD_BERRY,   CRUNCH, ROCK_SLIDE, EARTHQUAKE, SLUDGE_BOMB
	db 60, GYARADOS,   BITTER_BERRY, RAIN_DANCE, SURF, THRASH, HYPER_BEAM
	db 62, CHARIZARD,  BITTER_BERRY, FLAMETHROWER, OUTRAGE, EARTHQUAKE, SLASH
	db 63, KINGDRA,    GOLD_BERRY,   RAIN_DANCE, DRAGONBREATH, OCTAZOOKA, HYPER_BEAM
	db 65, DRAGONITE,  BITTER_BERRY, THUNDER_WAVE, OUTRAGE, THUNDER, HYPER_BEAM
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 62, OMASTAR,    ANCIENTPOWER, AURORA_BEAM, PROTECT, BUBBLEBEAM
	db 62, KABUTOPS,   SLASH, FLAIL, DIG, ANCIENTPOWER
	db 63, CORSOLA,    BUBBLEBEAM, ANCIENTPOWER, SPIKE_CANNON, RECOVER
	db 63, SUDOWOODO,  ROCK_SLIDE, THUNDERPUNCH, EARTHQUAKE, ICE_PUNCH  
	db 65, GOLEM,      ROCK_SLIDE, EARTHQUAKE, HYPER_BEAM, PROTECT
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 62, GOLDUCK,    HYDRO_PUMP, DIG, ICE_BEAM, PSYCHIC_M
	db 62, QUAGSIRE,   RAIN_DANCE, SURF, EARTHQUAKE, BODY_SLAM
	db 63, OCTILLERY,  OCTAZOOKA, ICE_BEAM, HYPER_BEAM, RAIN_DANCE
	db 63, AZUMARILL,  SURF, MOONBLAST, FUTURE_SIGHT, SWIFT
	db 65, POLITOED,   SURF, DETECT, ATTRACT, ICE_BEAM
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 62, RAICHU,     THUNDER_WAVE, REVERSAL, THUNDERBOLT, DOUBLE_TEAM
	db 62, ELECTRODE,  SCREECH, DOUBLE_TEAM, SWIFT, THUNDER
	db 63, MAGNETON,   LOCK_ON, TRI_ATTACK, RAIN_DANCE, ZAP_CANNON
	db 63, ELECTABUZZ, BODY_SLAM, PSYCHIC_M, CROSS_CHOP, THUNDER
	db 65, AMPHAROS,   RAIN_DANCE, HYPER_BEAM, COTTON_SPORE, THUNDER
	db -1 ; end
...
ErikaGroup:
	...
	db 62, TANGELA,    GROWTH, CONFUSION, GIGA_DRAIN, SLEEP_POWDER
	db 62, JUMPLUFF,   MEGA_DRAIN, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN
	db 63, VICTREEBEL, SUNNY_DAY, SYNTHESIS, SLUDGE_BOMB, RAZOR_LEAF
	db 63, VILEPLUME,  SUNNY_DAY, MOONLIGHT, SLUDGE_BOMB, SOLARBEAM
...
JanineGroup:
	...
	db 62, VENOMOTH,   PSYCHIC_M, SLUDGE_BOMB, SWIFT, GIGA_DRAIN
	db 62, QWILFISH,   HYDRO_PUMP, SLUDGE_BOMB, TOXIC, ROLLOUT
	db 63, GOLBAT,     WING_ATTACK, SLUDGE_BOMB, TOXIC, GIGA_DRAIN
	db 63, TENTACRUEL, HYDRO_PUMP, SLUDGE_BOMB, TOXIC, ICE_BEAM
	db 66, NIDOQUEEN,  BODY_SLAM, EARTHQUAKE, BITE, ICE_BEAM
	db -1 ; end
...
PokemaniacGroup:
	; POKEMANIAC LARRY (1) UNION CAVE 1F
...
SabrinaGroup:
	...
	db 62, SLOWBRO,    SURF, PSYCHIC_M, TRI_ATTACK, ICE_BEAM
	db 62, HYPNO,      FUTURE_SIGHT, TRI_ATTACK, LIGHT_SCREEN, PSYCHIC_M
	db 63, KADABRA,    RECOVER, FUTURE_SIGHT, PSYCHIC_M, LIGHT_SCREEN
	db 63, STARMIE,    SURF, REFLECT, ICE_BEAM, PSYCHIC_M
	db 66, MR__MIME,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db -1 ; end
...
BugCatcherGroup:
	...
	; BUG_CATCHER AL (6) AZALEA GYM
	db "AL@", TRAINERTYPE_MOVES
	db 12, METAPOD,    TACKLE, STRING_SHOT, HARDEN, SPIDER_WEB
	db 12, KAKUNA,     POISON_STING, STRING_SHOT, HARDEN, SHARPEN
	db -1 ; end

	; BUG_CATCHER JOSH (7) AZALEA GYM
...
SailorGroup:
	...
	db 18, KRABBY,     BUBBLE, LEER, CLAMP, HARDEN
	db 20, KRABBY,     BUBBLEBEAM, LEER, CLAMP, HARDEN
	db -1 ; end
...
Rival2Group:
	...
	db 62, MAGNETON,   THUNDERSHOCK, SONICBOOM, THUNDER_WAVE, SWIFT
	db 65, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 65, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 68, MEGANIUM,   RAZOR_LEAF, POISONPOWDER, BODY_SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	db 65, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 65, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 68, TYPHLOSION, SMOKESCREEN, QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
	...
	db 65, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 65, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 68, FERALIGATR, RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end

	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 68, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 72, CROBAT,     TOXIC, BITE, CONFUSE_RAY, WING_ATTACK
	db 68, MAGNETON,   THUNDER, SONICBOOM, THUNDER_WAVE, SWIFT
	db 69, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 69, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 75, MEGANIUM,   GIGA_DRAIN, BODY_SLAM, LIGHT_SCREEN, SAFEGUARD
	db -1 ; end
	...
	db 69, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 69, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 75, TYPHLOSION, SMOKESCREEN, QUICK_ATTACK, FIRE_BLAST, SWIFT
	db -1 ; end
	...
	db 69, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 69, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 75, FERALIGATR, SURF, RAIN_DANCE, SLASH, SCREECH
	db -1 ; end
...
HikerGroup:
	; HIKER ANTHONY (1) ROUTE 33
	db "ANTHONY@", TRAINERTYPE_NORMAL
	db 16, GEODUDE
	db 18, MACHAMP
	db -1 ; end

	; HIKER RUSSELL (2) UNION CAVE 1F
...
BlaineGroup:
	...
	db 62, MAGCARGO,   CURSE, BODY_SLAM, FLAMETHROWER, ROCK_SLIDE
	db 62, FLAREON,    FLAMETHROWER, HEADBUTT, HYPER_BEAM, ZAP_CANNON
	db 63, NINETALES,  FIRE_BLAST, CONFUSE_RAY, PSYCHIC_M, FAINT_ATTACK
	db 63, RAPIDASH,   FIRE_BLAST, DOUBLE_KICK, SUNNY_DAY, HYPER_BEAM
	db 66, MAGMAR,     SUNNY_DAY, FIRE_BLAST, THUNDERPUNCH, CROSS_CHOP
	db -1 ; end
...
FirebreatherGroup:
	...
	; FIREBREATHER BILL (5) UNION CAVE 1F
